...
class MemoryRetrievalViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate , UITextFieldDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        weak var weakSelf : MemoryRetrievalViewController? = self;
